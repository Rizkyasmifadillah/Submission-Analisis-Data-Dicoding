...
# Cek untuk geolocation dan inisialisasi
if 'customer_lat' in geolocation.columns and 'customer_lng' in geolocation.columns:
    map_plot = BrazilMapPlotter(geolocation, plt, mpimg, urllib, st)
else:
    st.warning("Kolom 'customer_lat' atau 'customer_lng' tidak ditemukan dalam data geolocation. Peta tidak dapat ditampilkan.")
    map_plot = None  # Set map_plot ke None jika kolom tidak ada
