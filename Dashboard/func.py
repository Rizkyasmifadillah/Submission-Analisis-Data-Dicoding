...
class DataAnalyzer:
    ...
    def create_daily_orders_df(self) -> pd.DataFrame:
    ...
    def create_sum_spend_df(self) -> pd.DataFrame:
    ...
    def create_sum_order_items_df(self) -> pd.DataFrame:
    ...
    def create_order_status(self) -> tuple:
